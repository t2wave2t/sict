            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <!--<li><a href="" ><i class="fa fa-users"></i>Thông tin cá nhân</a>
                  </li>-->
                  <li><a href="<?php echo route('sv.getTKB'); ?>" ><i class="fa fa-calendar"></i>Thời khóa biểu</a>
                  </li>
                  <li><a href="<?php echo route('sv.getIndex'); ?>" ><i class="fa fa-table"></i> Điểm học phần</a>
                  </li>

                  <li><a href="<?php echo route('sv.getLienhe'); ?>" ><i class="fa fa-users"></i>Liên hệ Giảng viên</a>
                  </li>
                  <li><a href="<?php echo route('sv.xacnhanhoc'); ?>" ><i class="fa fa-calendar"></i>Xác nhận học tập</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{ url('public/gv/images/img.jpg') }}" alt="">{!! $tt_sv['hodem'] !!} {!! $tt_sv['ten']  !!}
