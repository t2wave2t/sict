...
?>
    <?php 
      $count = 1; 
      $duoi=0;
      $tren=$soluongsv[0];  $temp=1;
      array_push($soluongsv, "10");
    ?>
    @for($i=0; $i<$solop; $i++) 
    <p class="indanhsach">
    ...
    <table width="100%" id="table2">
        <tr>
          ...
          <td width="50%">Ngày thi: <b>{!! $ngaythi[$i] !!}</b></td>
        </tr>
        <tr>
          <td>
            Tên lớp học phần: <b>{!! $lopthi[$i] !!}</b>
          </td>
           
          <td>Giờ thi: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>{!! $giothi[$i] !!}</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Phòng thi: <b>{!! $phongthi[$i] !!}</b></td>
        </tr>
        <tr>
          <td>
      ...
      <thead>
        ...
        @else
          <tr>
            ...
            @else
              <th colspan="4" width="40%">THI KẾT THÚC</th>
            @endif
            <th rowspan="3" width="6%">GHI CHÚ</th>
          </tr>
          <tr>
            ...
            @else
              <th rowspan="2" width="4%">CHUYÊN CẦN (20%)</th>
            @endif
            <th rowspan="2" width="5%">MÃ ĐỀ THI</th>
          ...
          @if($count <= $tren)
            ...
            @else
              <tr class="content">
                ...
                <td></td>
                <td align="center"></td>
                <td align="center"><span style="font-size: 7px;"></td>            
                <td align="center"> 
                  @if($item->trangthai == 1)
        ...
        <?php 
          array_splice($soluongsv, 0, 1);
          $tren = $count+$soluongsv[0]-1;
        ?>
    </table>
